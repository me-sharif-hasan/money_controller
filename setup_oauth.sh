...
echo "   - Enable: People API (required for web)"
echo ""
...
echo "   - Android: Works with Android OAuth client"
echo "   - Web: Requires People API to be enabled"
echo "   - If testing on web and getting 403, enable People API"
echo ""
echo "========================================"
